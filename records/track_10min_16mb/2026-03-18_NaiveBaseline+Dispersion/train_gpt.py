...
class GPT(nn.Module):
    def __init__(
        ...
        self._dispersion = DispersionLoss(variant="angular_spread")
        self._init_weights()
    ...
    def forward(self, input_ids: Tensor, target_ids: Tensor) -> Tensor:
        ...
        disp_term = (
            _DISPERSION_COEFF * self._dispersion(x) if self.training else None
        )
        ...
        return ce + disp_term if disp_term is not None else ce
